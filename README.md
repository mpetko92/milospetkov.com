...
- **CV PDF:** auto-generated from the same content as the site. After editing
  `data/content.ts`, run `npm run generate-cv` to refresh [`public/cv.pdf`](./public/cv.pdf).
  The **Download CV** button serves this file.
...
public/cv.pdf         # generated by npm run generate-cv
